          ...
          <div className="p-4 sm:p-8 bg-gray-50 min-h-screen">
            <div
              className={`overflow-x-auto rounded-lg ${
                loading
                  ? "p-10 shadow-none"
                  : `${users && users.length > 0 ? "shadow-lg" : "shadow-none"}`
              }`}
            >
              {loading ? (
                ...
                <table className="min-w-full bg-white border border-gray-200">
                  <thead className="bg-blue-100 text-gray-700">
                    <tr>
                      <th className="p-3 px-4 text-left">Avatar</th>
                      <th className="p-3 px-4 text-left">Name</th>
                      <th className="p-3 px-4 text-left">Email</th>
                      <th className="p-3 px-4 text-left">Registered On</th>
            ...
            {!loading && users.length > 0 && (
              <div className="flex justify-center mt-6 gap-4">
                ...
                <span className="px-4 py-2 text-gray-700">Page {page} of {maxPage}</span>
                <button
