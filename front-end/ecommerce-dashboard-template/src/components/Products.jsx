...
const Products = () => {
  ...
  const { loading, products, fetchingProducts, totalProducts } = useSelector(
    (state) => state.product
  );
              ...
              {fetchingProducts ? (
                ...
                <table className="min-w-full bg-white border border-gray-200">
                  <thead className="bg-blue-100 text-gray-700">
                    <tr>
                      <th className="p-3 px-4 text-left">Image</th>
                      <th className="p-3 px-4 text-left">Title</th>
                      <th className="p-3 px-4 text-left">Category</th>
                      <th className="p-3 px-4 text-left">Price</th>
                      <th className="p-3 px-4 text-left">Stock</th>
                      <th className="p-3 px-4 text-left">Rating</th>
                      <th className="p-3 px-4 text-left">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
