      ...
      <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="my-6 flex items-center justify-center space-x-3 p-3 rounded-lg glass-card 
            hover:glow-on-hover hover:text-destructive-foreground animate-smooth group w-full text-destructive"
          >
