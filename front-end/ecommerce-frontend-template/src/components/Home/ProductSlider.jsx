  ...
  return (
    <>
      <section className="py-6">
        ...
        <div
          ref={scrollRef}
          className="flex space-x-6 overflow-x-auto scrollbar-hide pg-4"
        >
          {products.map((product) => {
            return (
              <Link
                ...
                className="flex-shrink-0 w-80 glass-card hover:glow-on-hover animate-smooth rounded-lg overflow-hidden group"
              >
                {/* PRODUCT IMAGES */}
                <div className="relative overflow-hidden rounded-lg mb-4">
                  ...
                  <button
                    ...
                    className="absolute bottom-3 right-3 p-2 glass-card hover:glow-on-hover animate-smooth opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"
