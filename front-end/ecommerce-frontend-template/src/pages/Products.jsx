...
const Products = () => {
  ...
  const [searchQuery, setSearchQuery] = React.useState(searchItem) || "";
  const [selectedCategory, setSelectedCategory] =
    React.useState(searchedCategory) || "";
  const [priceRange, setPriceRange] = React.useState([0, 10000]) || [0, 10000];
  ...
  useEffect(() => {
    ...
    dispatch(
      fetchAllProducts({
        ...
        search: searchQuery,
        ratings: selectedRating > 0 ? selectedRating : "", // just send when > 0
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    {[5, 4, 3, 2, 1].map((ratings) => {
                      return (
                        <button
                          ...
                          onClick={() => {
                            setSelectedRating(
                              selectedRating === ratings ? 0 : ratings
                            );
                            setCurrentPage(1);
                          }}
            ...
            <div className="flex-1">
              ...
              <div className="mb-8 flex max-[440px]:flex-col items-center gap-2">
                ...
                >
                  <span
                    className="relative w-full px-3 py-3 transition-all ease-in duration-75 
      ...
      {/* Mount modal ở ngoài layout để overlay hoạt động */}
      <AISearchModal />
    </>
  );
};
